          ...
          >
            <div
              className={cn(
                ...
                msg.role === 'user'
                  ? 'bg-dental-blue text-white rounded-br-md'
            ...
            <div className="space-y-2">
              {pipelineStatuses.map((ps, idx) => (
                <div key={idx} className="flex items-center gap-2 text-sm">
                  {ps.status === 'running' && (
                    <div className="h-2 w-2 rounded-full bg-dental-blue animate-pulse" />
                  )}
                  {ps.status === 'complete' && (
        ...
        <div className="flex gap-2 px-4 pb-2 flex-wrap">
          {suggestions.map((chip) => (
            <button
              ...
              className="rounded-full border border-dental-blue-200 bg-dental-blue-50 px-3 py-1 text-xs text-dental-blue-700 hover:bg-dental-blue-100 transition-colors"
            >
              {chip.label}
            </button>
          ))}
      ...
      <div className="border-t p-4">
        <div className="flex gap-2">
          <input
            ...
            className="flex-1 rounded-lg border border-gray-300 px-4 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-dental-blue-200 focus:border-dental-blue"
          />
